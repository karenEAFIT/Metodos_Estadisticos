...
El código realizado para la ejecución del presente trabajo se encuentra en el [ repositiorio git](https://github.com/KarenVelasquez181402/Metodos_Estadisticos) **https://github.com/KarenVelasquez181402/Metodos_Estadisticos**, en este repositorio se encuentraran el código con el cual fue desarrollado el presente trabajo, el código para la ejecución del informe y los set de datos utilizados para cumplir con el objetivo del mismo.
